...
namespace MilkTea.Client.Forms.ChildForm_Discount
{
    partial class EditDiscountForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel8 = new Panel();
            dGV_sp_KM_EDIT = new DataGridView();
            chon_edit = new DataGridViewCheckBoxColumn();
            maSP_edit = new DataGridViewTextBoxColumn();
            tenSanPham_edit = new DataGridViewTextBoxColumn();
            loai_edit = new DataGridViewTextBoxColumn();
            panel4 = new Panel();
            panel14 = new Panel();
            panel23 = new Panel();
            panel46 = new Panel();
            ...
            ((System.ComponentModel.ISupportInitialize)dGV_sp_KM_EDIT).BeginInit();
            ...
            // dGV_sp_KM_EDIT
            // 
            dGV_sp_KM_EDIT.AllowUserToAddRows = false;
            dGV_sp_KM_EDIT.AllowUserToDeleteRows = false;
            dGV_sp_KM_EDIT.AllowUserToResizeColumns = false;
            dGV_sp_KM_EDIT.AllowUserToResizeRows = false;
            dGV_sp_KM_EDIT.BackgroundColor = SystemColors.ButtonFace;
            dGV_sp_KM_EDIT.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dGV_sp_KM_EDIT.Columns.AddRange(new DataGridViewColumn[] { chon_edit, maSP_edit, tenSanPham_edit, loai_edit });
            dGV_sp_KM_EDIT.Dock = DockStyle.Top;
            dGV_sp_KM_EDIT.Location = new Point(0, 63);
            dGV_sp_KM_EDIT.Name = "dGV_sp_KM_EDIT";
            dGV_sp_KM_EDIT.Size = new Size(1020, 291);
            dGV_sp_KM_EDIT.TabIndex = 1;
            // 
            // chon_edit
            // 
            chon_edit.AutoSizeMode = DataGridViewAutoSizeColumnMode.None;
            chon_edit.HeaderText = "Chọn";
            chon_edit.Name = "chon_edit";
            chon_edit.Width = 60;
            // 
            // maSP_edit
            // 
            maSP_edit.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            maSP_edit.HeaderText = "Mã sản phẩm";
            maSP_edit.Name = "maSP_edit";
            maSP_edit.Width = 104;
            // 
            // tenSanPham_edit
            // 
            tenSanPham_edit.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            tenSanPham_edit.HeaderText = "Tên sản phẩm";
            tenSanPham_edit.Name = "tenSanPham_edit";
            // 
            // loai_edit
            // 
            loai_edit.AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
            loai_edit.HeaderText = "Loại sản phẩm";
            loai_edit.Name = "loai_edit";
            // 
            // panel4
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)dGV_sp_KM_EDIT).EndInit();
